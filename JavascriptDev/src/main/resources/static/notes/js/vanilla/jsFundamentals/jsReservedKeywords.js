...
The following reserved words marked with ^ have been REMOVED from the ECMAScript 5/6 standard.
That said, still Do not use any of these ^ words as variables since ECMAScript 5/6 does not have full support in all browsers.
 */ 
